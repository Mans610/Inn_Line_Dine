...
class TableOrderDetails extends StatefulWidget {
  final int tableNumber;
  final Hotel hotel;
  final Function onFetchCurrentTable;
  const TableOrderDetails({Key? key,required this.onFetchCurrentTable, required this.tableNumber, required this.hotel}) : super(key: key);

  @override
  _TableOrderDetailsState createState() => _TableOrderDetailsState();
}

class _TableOrderDetailsState extends State<TableOrderDetails> {
  Order? currentOrder;
